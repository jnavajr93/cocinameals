        ...
        const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
          ...
          body: JSON.stringify({
            ...
            messages: [
              {
                role: "system",
                content: "You write clear, practical, restaurant-quality home cooking recipes in plain text. No markdown. No asterisks. No bullet symbols. Follow the exact format given.",
              },
